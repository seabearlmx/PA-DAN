...
from padan.model.deeplabv2 import Bottleneck, ResNetMulti

AFFINE_PAR = True


class PadanResNet(ResNetMulti):
...
def get_padan_deeplab(num_classes=16, multi_level=False):
    model = PadanResNet(
