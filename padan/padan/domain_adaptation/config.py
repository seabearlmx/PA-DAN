...
from padan.utils.serialization import yaml_load
...
cfg.DATA_LIST_SOURCE = str(project_root / 'padan/dataset/gta5_list/{}.txt')
cfg.DATA_LIST_TARGET = str(project_root / 'padan/dataset/cityscapes_list/{}.txt')
# Directories
cfg.DATA_DIRECTORY_SOURCE = str('./DADatasets/GTA5/data')
cfg.DATA_DIRECTORY_TARGET = str('./DADatasets/Cityscapes')
...
cfg.TRAIN.INFO_TARGET = str(project_root / 'padan/dataset/cityscapes_list/info.json')
# Segmentation network params
cfg.TRAIN.MODEL = "DeepLabv2_padan"
...
cfg.TEST.MODE = 'best'
# model
cfg.TEST.MODEL = ("DeepLabv2_padan",)
...
cfg.TEST.INFO_TARGET = str(project_root / 'padan/dataset/cityscapes_list/info.json')
