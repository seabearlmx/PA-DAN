...
from padan.domain_adaptation.generation_pesudo_label import evaluate_domain_adaptation
...
def main(config_file, exp_suffix):
    ...
    for i in range(n_models):
        if cfg.TEST.MODEL[i] == 'DeepLabv2_padan':
            model = get_padan_deeplab(num_classes=cfg.NUM_CLASSES,
