...
from padan.dataset.gta5 import GTA5DataSet
from padan.dataset.cityscapes import CityscapesDataSet
from padan.domain_adaptation.config import cfg, cfg_from_file
from padan.model.deeplab_padan import get_padan_deeplab
from padan.domain_adaptation.train_UDA import train_domain_adaptation_with_padan
...
def main():
    ...
    if cfg.TRAIN.MODEL == 'DeepLabv2_padan':
        model = get_padan_deeplab(num_classes=cfg.NUM_CLASSES, multi_level=cfg.TRAIN.MULTI_LEVEL)
    ...
    # UDA TRAINING
    train_domain_adaptation_with_padan(model, source_loader, target_loader, cfg)
