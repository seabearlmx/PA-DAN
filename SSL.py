...
from osdan.domain_adaptation.generation_pesudo_label import evaluate_domain_adaptation
...
def main(config_file, exp_suffix):
    ...
    for i in range(n_models):
        if cfg.TEST.MODEL[i] == 'DeepLabv2_osdan':
            model = get_osdan_deeplab(num_classes=cfg.NUM_CLASSES,
