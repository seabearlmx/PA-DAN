...
from osdan.model.discriminator import get_fc_discriminator
from osdan.utils.func import adjust_learning_rate, adjust_learning_rate_discriminator
from osdan.utils.func import loss_calc, bce_loss
from osdan.utils.loss import entropy_loss
from osdan.utils.func import prob_2_entropy
from osdan.utils.viz_segmask import colorize_mask
...
def train_domain_adaptation_with_osdan(model, trainloader, targetloader, cfg):
    if cfg.TRAIN.DA_METHOD == 'OSDAN':
