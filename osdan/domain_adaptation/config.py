...
from osdan.utils import project_root
from osdan.utils.serialization import yaml_load
...
cfg.DATA_LIST_SOURCE = str(project_root / 'osdan/dataset/gta5_list/{}.txt')
cfg.DATA_LIST_TARGET = str(project_root / 'osdan/dataset/cityscapes_list/{}.txt')
# Directories
cfg.DATA_DIRECTORY_SOURCE = str('/media/lmx/6cfbc870-f055-4400-aebc-62115a99fbe4/DADatasets/GTA5/data')
cfg.DATA_DIRECTORY_TARGET = str('/media/lmx/6cfbc870-f055-4400-aebc-62115a99fbe4/DADatasets/Cityscapes')
...
cfg.TRAIN.INFO_TARGET = str(project_root / 'osdan/dataset/cityscapes_list/info.json')
# Segmentation network params
cfg.TRAIN.MODEL = "DeepLabv2_osdan"
...
cfg.TEST.MODE = 'best'
# model
cfg.TEST.MODEL = ("DeepLabv2_osdan",)
...
cfg.TEST.INFO_TARGET = str(project_root / 'osdan/dataset/cityscapes_list/info.json')
